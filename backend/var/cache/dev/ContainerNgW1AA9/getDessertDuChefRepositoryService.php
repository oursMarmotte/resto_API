 ...
 */
class getDessertDuChefRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DessertDuChefRepository' shared autowired service.
     *
     * @return \App\Repository\DessertDuChefRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DessertDuChefRepository.php';

        return $container->privates['App\\Repository\\DessertDuChefRepository'] = new \App\Repository\DessertDuChefRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
