 ...
 */
class getFoodCategoryRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FoodCategoryRepository.php';

        return $container->privates['App\\Repository\\FoodCategoryRepository'] = new \App\Repository\FoodCategoryRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
