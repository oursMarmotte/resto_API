 ...
 */
class getEntreDuChefRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EntreDuChefRepository' shared autowired service.
     *
     * @return \App\Repository\EntreDuChefRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EntreDuChefRepository.php';

        return $container->privates['App\\Repository\\EntreDuChefRepository'] = new \App\Repository\EntreDuChefRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
