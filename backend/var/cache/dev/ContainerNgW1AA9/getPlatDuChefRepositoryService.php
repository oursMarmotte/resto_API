 ...
 */
class getPlatDuChefRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PlatDuChefRepository' shared autowired service.
     *
     * @return \App\Repository\PlatDuChefRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PlatDuChefRepository.php';

        return $container->privates['App\\Repository\\PlatDuChefRepository'] = new \App\Repository\PlatDuChefRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
